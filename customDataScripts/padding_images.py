...
def main(root_directory, target_size):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--target_size', type=int, default=1248, help='Target width for padding')

    args = parser.parse_args()

    main(args.root_directory, args.target_size)
